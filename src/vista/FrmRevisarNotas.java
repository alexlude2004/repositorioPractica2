 ...
 * @author Asus
 */
public class FrmRevisarNotas extends javax.swing.JFrame {
    /**
     * Creates new form FrmVendedor
     */
    public FrmRevisarNotas() {
        initComponents();
        //limpiar();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Cuadro de Calificaciones");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRevisarNotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRevisarNotas().setVisible(true);
            }
        });
    }
